<template>
    <div class="gallery-grid row">
        <!-- Grid Column -->
        <div v-for="item in props.items" v-show="item.visible" class="gallery-grid-col col-4 col-xl-3 text-center"
            ...
            <div class="gallery-item" @click="_onItemClicked(item)">
                ...
                <div class="gallery-thumb-wrapper">
                    <ImageView :src="item.data['logoUrl']" :alt="item.data['locales']['name']" class="gallery-thumb" />
