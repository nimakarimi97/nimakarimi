                ...
                <div v-if="props.project" class="modal-body py-5 py-lg-4">
                    ...
                    <div class="row text-center text-lg-start p-2 p-md-4">
                        ...
                        <div class="col-12 col-lg-4 pe-0 pe-lg-4">
                            <ImageView :src="props.project['logoUrl']" :alt="props.project['title']"
                                :spinner-enabled="true" class="img-fluid logo my-auto my-lg-0 mb-3" />
                        </div>
                        ...
                        <div class="col-12 col-lg-8">
                            ...
                            <div class="text-4">
                                ...
                                {{ data.getString('tags') }}:
                                <Tags :items="props.project['locales']['tags']" :item-class="'bg-primary'"
                                    class="d-inline ms-2" />
                            </div>
...
.modal-subsection {
    @include generate-dynamic-styles-with-hash((xxxl: (margin-top: 35px),
            lg: (margin-top: 30px),
            sm: (margin-top: 25px)))
}

.logo {
    @include generate-dynamic-styles-with-hash((xxxl: (max-width: 100%),
