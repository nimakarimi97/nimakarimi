...
.contact-item {
    @include generate-dynamic-styles-with-hash((xxxl: (height:85px),
            xl: (height:75px),
            lg: (height:65px),
            md: (height:60px),
            sm: (height:55px)));
...
.contact-item-content {
    @include generate-dynamic-styles-with-hash((xxxl: (margin-top:5px),
            lg: (margin-top:1px)));
...
.contact-item-title {
    @include generate-dynamic-styles-with-hash((xxxl: (margin-bottom: 0.25rem),
