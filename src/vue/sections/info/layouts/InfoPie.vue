        ...
        <div class="col-12 col-xl-7 col-xxl-8 d-flex pt-3">
            <div class="row gy-1 gy-xl-3 gx-md-5 items-wrapper">
                <div v-for="item in props.items" class="col-12 col-sm-6 item-container">
                    <InfoItem :item="item" :highlighted-header="false" :small-description="true"
                        :description-with-progress-bar="false" :icon-color-style="'customColor'" />
                </div>
            </div>
        </div>
    </div>
...
.item-container {
    @include generate-dynamic-styles-with-hash((xxxl: (min-height:4.0rem),
