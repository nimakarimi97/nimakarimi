...
.section-container {
    @include generate-dynamic-styles-with-hash((xxxl: (padding: clamp(5rem, 5vw, 10rem) clamp(5rem, 5vw, 10rem) clamp(6rem, 5vw, 10rem)),
...
.section-header {
    @include generate-dynamic-styles-with-hash((xxxl: (margin-bottom:3rem),
