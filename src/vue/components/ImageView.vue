<template>
    <div class="image-view">
        <!-- Image -->
        <img ref="img" v-show="isLoaded()" :src="props.src" :alt="props.alt" :class="classList" @load="_onLoad"
            @error="_onError">
...
.preloader-gif {
    @include generate-dynamic-styles-with-hash((xxxl: (max-width: 200px, max-height:200px),
