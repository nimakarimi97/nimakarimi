...
.nav-item {
    @include generate-dynamic-styles-with-hash((xxxl: (font-size:0.9rem, border-width:2px, min-height: min(50px, 10vh)),
...
.nav-pill-icon {
    @include generate-dynamic-styles-with-hash((xxxl: (width:30px),
            sm: (width:25px),
        ));
